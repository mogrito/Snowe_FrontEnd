...
function SocialView(){
  ...
  const fetchBoardData = async () => {
    console.log('Fetching board data...'); // 로그 추가
    try {
  ...
  function FreeBoardScreen() {
    ...
    console.log('FreeBoardScreen rendered'); // 로그 추가
